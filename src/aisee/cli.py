...
def build_parser() -> argparse.ArgumentParser:
    ...
    m.add_argument("--image"); m.add_argument("--gpu-frac", type=float)
    m.add_argument("--port", type=int); m.add_argument("--idle-timeout", type=int)
    m.add_argument("--arg", action="append", help="extra vllm serve arg (repeatable)")
    m.add_argument("--hf-token")
    m = ms.add_parser("remove"); m.add_argument("slug")
    ms.add_parser("list")
    m = ms.add_parser("start"); m.add_argument("slug"); add_server(m)
    m = ms.add_parser("stop"); m.add_argument("slug"); add_server(m)
    m = ms.add_parser("logs"); m.add_argument("slug"); m.add_argument("-n", type=int, default=60)
    m = ms.add_parser("default"); m.add_argument("slug")
    ...
    m = cs.add_parser("set"); m.add_argument("key"); m.add_argument("value", nargs="?")
    m = cs.add_parser("unset"); m.add_argument("key")
    cs.add_parser("list")
    ...
    def add_query(p, need_q: bool, need_e: bool):
        ...
        p.add_argument("--context"); p.add_argument("--context-file")
    ...
    p.add_argument("--model"); p.add_argument("--fps", type=float)
    p.add_argument("--chunk-seconds", type=float); p.add_argument("--scale", type=int)
    ...
    m = ts.add_parser("list"); m.add_argument("--status"); m.add_argument("--model")
    m = ts.add_parser("show"); m.add_argument("id")
    m = ts.add_parser("cancel"); m.add_argument("id")
